...
module.exports = [
  js.configs.recommended,
  {
    ...
    rules: {
      ...
      // Accessibility rules for medical UI
      'jsx-a11y/alt-text': 'error',
      'jsx-a11y/aria-props': 'error',
      'jsx-a11y/aria-proptypes': 'error',
      'jsx-a11y/aria-unsupported-elements': 'error',
      'jsx-a11y/role-has-required-aria-props': 'error',
      'jsx-a11y/role-supports-aria-props': 'warn', // Downgrade to warn for some edge cases
  ...
  },
  {
    ...
    rules: {
      '@typescript-eslint/no-unused-vars': 'off', // Stories often have unused imports
      'react-hooks/rules-of-hooks': 'off', // Storybook render functions can use hooks
    },
  },
  {
    // Special configuration for config files
    files: ['*.config.{js,ts}', 'tailwind.config.preset.js'],
    languageOptions: {
      globals: {
        module: 'readonly',
        require: 'readonly',
